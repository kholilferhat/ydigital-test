<footer>
    ...
    <div class="right-container">
        <div class="mobileAppContainer">
            <img src="/assets/footer-phone.avif" alt="erha mobile phone">
        </div>
        <div class="cta-container">
            <div class="cta-content">
                ...
                <p class="cta">Download Sekarang</p>
            </div>
            <div class="icon-container">
                <a href="https://play.google.com/store/apps/details?id=id.erha.userapp&pcampaignid=web_share">
                    <img src="/assets/playstore.avif" alt="erha playstore">
                </a>
                <a href="https://apps.apple.com/id/app/erha-buddy/id1507965731?l=id">
                    <img src="/assets/appstore.avif" alt="erha appstore">
                </a>
            </div>
        </div>
    </div>
